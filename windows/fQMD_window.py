...
class fqmd_window_class(QtGui.QWidget):
	def __init__(self, parent, par):
		...
		if surfaceConformation_visible == True and os.path.exists(surfaceConformation_path):
		...
		if surfaceFeatureExtractDict_visible == True and os.path.exists(surfaceFeatureExtractDict_path):
		...
		if shortEdgeFilter_visible == True and os.path.exists(shortEdgeFilter_path):
